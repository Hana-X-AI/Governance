**Document Type**: Governance - Agent Directory & Coordination Reference  
**Created**: 2025-11-05  
**Topic**: Agent Catalog & Role Assignments  
**Purpose**: Centralized directory of all AI agents, roles, responsibilities, and coordination protocols  
...
- **Primary Responsibilities**:
  ...
  - Manage internal DNS records (hx.dev.local zone)
  - Implement identity and access policies
  - Domain controller administration (samba-tool)
- **Layer**: Identity & Trust
- **Zone**: Identity Zone
- **Profile**: `0.0-governance/0.0.5-Delivery/0.0.5.1-agents/0.0.5.1.10-agent-frank.md`
...
| 1.1 | 2025-11-06 | Updated file path references to new hierarchical naming | Agent Zero |
...
- `0.0.1.6-agent-persona-reference.md` - Agent Persona Standards
- `0.0.1.7-agent-selection-guide.md` - Agent Selection Guide  
**Classification**: Internal  
