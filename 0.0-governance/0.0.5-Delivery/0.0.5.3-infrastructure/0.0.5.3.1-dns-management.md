...
**Created**: 2025-11-05  
**Topic**: DNS Management in hx.dev.local  
**Purpose**: Register service hostnames in domain DNS during deployment  
...
- **SSL/TLS Deployment**: `0.0.5.3.3-ssl-tls-deployment.md`
- **Credentials Reference**: `0.0.5.2-credentials/0.0.5.2.1-credentials.md`
