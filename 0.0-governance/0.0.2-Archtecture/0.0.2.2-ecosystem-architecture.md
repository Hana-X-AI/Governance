...
**Topic**: High-level system architecture and design patterns  
**Purpose**: Comprehensive architectural blueprint connecting strategic vision with physical infrastructure and operational principles  
...
- [Platform Nodes](./0.0.2.1-platform-nodes.md)  
