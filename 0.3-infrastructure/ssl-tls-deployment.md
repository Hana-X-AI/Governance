...
1. Open: `http://<HOSTNAME>.hx.dev.local/` → Should redirect to HTTPS
2. Open: `https://<HOSTNAME>.hx.dev.local/` → Should show 🔒 Secure
3. Click padlock → View certificate → Verify issuer and expiration
...
**Applies To**: Web services in hx.dev.local
**Referenced By**: All web service owner agents
